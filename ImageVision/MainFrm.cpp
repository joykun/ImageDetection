...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_wndSplitter.SetRowInfo(0, 80, 0);
	if (!m_wndSplitter.CreateView(0, 1, pContext->m_pNewViewClass, CSize(rect.Width() / 4, rect.Height()), pContext))return FALSE;
	m_wndSplitter.SetRowInfo(0, 20, 0);

	ControlView = (CView*)this->m_wndSplitter.GetPane(0, 0);
	ImageVisionView = (CView*)this->m_wndSplitter.GetPane(0, 1);
	return TRUE;
